...
function Router() {
  return <RoutedErrorBoundary><Switch><Route path="/" component={Dashboard} /><Route path="/news/new" component={NewsEditorPage} /><Route path="/news/:id/edit" component={NewsEditorPage} /><Route path="/news/:id" component={NewsArticlePage} /><Route path="/news" component={NewsPage} /><Route path="/work/:slug" component={WorkCategoryPage} /><Route path="/work" component={WorkHubPage} /><Route path="/learn/programs/:id" component={ProgramDetailPage} /><Route path="/learn/programs" component={ProgramsPage} /><Route path="/admin/forms/new" component={FormEditorPage} /><Route path="/admin/forms/:id/submissions" component={FormSubmissionsPage} /><Route path="/admin/forms/:id" component={FormEditorPage} /><Route path="/people/forms/category/:category" component={FormsListPage} /><Route path="/people/forms/:slug" component={FormPage} /><Route path="/people/forms" component={FormsListPage} /><Route path="/admin/users" component={UserManagementPage} /><Route path="/admin/portal-settings" component={PortalSettingsPage} /><Route path="/admin/programs/new" component={ProgramEditorPage} /><Route path="/admin/programs/:id" component={ProgramEditorPage} /><Route path="/admin/programs" component={ManageProgramsPage} /><Route path="/admin/onboarding/new" component={OnboardingEditorPage} /><Route path="/admin/onboarding/:id" component={OnboardingEditorPage} /><Route path="/admin/onboarding" component={ManageOnboardingPage} /><Route path="/admin/job-postings/new" component={JobPostingEditorPage} /><Route path="/admin/job-postings/:id" component={JobPostingEditorPage} /><Route path="/admin/job-postings" component={ManageJobPostingsPage} /><Route path="/people/recruiting" component={RecruitingPage} /><Route path="/people/onboarding" component={OnboardingPage} /><Route path="/people/directory" component={DirectoryPage} /><Route path="/profile" component={MyProfilePage} /><Route path="/updates" component={ChangelogPage} /><Route path="/search" component={SearchResultsPage} /><Route path="/tasks" component={TasksPage} /><Route path="/reporting" component={ReportingPage} /><Route path="/work-items/new" component={NewWorkItemPage} /><Route path="/work-items/:id" component={WorkItemDetail} /><Route path="/work-items" component={WorkItemsPage} /><Route component={NotFound} /></Switch></RoutedErrorBoundary>;
}
