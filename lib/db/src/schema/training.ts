...
export const trainingModulesTable = pgTable("training_modules", {
  ...
  // can't) actually lock the scrubber. Shown to the learner as a plain-text
  // warning on the module's intro screen instead (see ModuleWizard.tsx /
  // ProgramsPage.tsx), same honesty tradeoff as the existing "feedback only
  // shown after quiz" notice.
