...
SELECT id, 'Canon EOS R5 Mark II with TK North - Autofocus & pre-shooting (Sep-Nov)', 'lesson', '## Module Introduction
...
## Questionnaire
## Q1. What does the register people priority mode allow?
- Cinema EOS level options such as Custom Picture, Canon Log 2, Canon Log 3 and proxy recording
- Allows users to register their customized camera settings individually
- Camera to detect faces you input and prioritise focusing on them (correct)
## Q2. How many frames per second does the R5 Mark II give you when using the electronic shutter?
- 20 fps
- 30 fps (correct)
- 25 fps', 'https://youtube.com/watch?v=da7UksaTCjM&feature=youtu.be', 12
