...
SELECT id, 'Canon EOS R5 Mark II - 5 Key Selling Points (Sep-Nov)', 'lesson', '## Module Introduction
...
## Questionnaire
## Q1. What are the five (5) key features of the EOS R5 Mark II? (select all that apply)
- Next generation autofocus via deep learning (correct)
- Bigger battery than the EOS R5
- 45MP Back Illuminated Sensor (correct)
- Pre-Continuous Shooting (correct)
- 8K 60P Video Recording (correct)
- In-Camera Image Up-Scaling (correct)
- Large vertical grip like Canon EOS R1', 'https://www.youtube.com/watch?v=O7bHZe7Mrxg', 8
